        ...
        <Dialog as="div" className="relative z-10" onClose={handleClose}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded bg-neutral-700 p-6 text-center align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h5"
                  ...
                  <div className="flex flex-1  flex-col overflow-hidden bg-neutral-700  xl:p-[2px] lg:p-[5px] p-[2px]">
                              ...
                              <button
                                className={`inline-flex items-center justify-center px-4 py-2 border ${
                                  setting === value
                                    ...
                                    : "border-gray-100"
                                }  text-sm font-medium rounded-sm text-white bg-neutral-700`}
                                onClick={() => {
