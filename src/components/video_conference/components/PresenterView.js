...
export function PresenterView({ height }) {
  ...
  return (
    <div
      className={` bg-neutral-700 rounded m-2 relative overflow-hidden w-full h-[${
    ...
    >
      ...
      <div className={"video-contain absolute h-full w-full"}>
        ...
        />
        <div
          className="bottom-2 left-2 bg-neutral-700 p-2 absolute rounded-md flex items-center justify-center"
          style={{
        ...
        {isLocal ? (
          <>
            <div className="p-10 rounded-2xl flex flex-col items-center justify-center absolute top-1/2 left-1/2 bg-neutral-700 transform -translate-x-1/2 -translate-y-1/2">
              <ScreenShareIcon
